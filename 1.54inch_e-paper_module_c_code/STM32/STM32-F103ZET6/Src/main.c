...
int main(void)
{
  ...
  /* USER CODE BEGIN 2 */	
    ...
    Paint_DrawCircle(45, 35, 15, BLACK, DRAW_FILL_EMPTY, DOT_PIXEL_1X1);
    Paint_DrawCircle(105, 30, 15, BLACK, DRAW_FILL_FULL, DOT_PIXEL_1X1);    
